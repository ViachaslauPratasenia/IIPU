...
namespace global_variables
{
	...
	static bool invertMouseButton = false;
}
...
LRESULT CALLBACK LowLevelMouseProc(int nCode, WPARAM wParam, LPARAM lParam)
{
	...
	if (nCode >= 0)
	{
		...
		SwapMouseButton(global_variables::invertMouseButton);
	}
